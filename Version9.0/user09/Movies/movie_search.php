...
<style>
    ...
    <link rel="icon" href="https://timesofindia.indiatimes.com/thumb/msid-67586673,width-800,height-600,resizemode-4/67586673.jpg">
    </head>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <!-- <ul class="nav navbar-nav">
            ...
            <li><a href="mailto:adrianfrimpong@gmail.com?Subject=Hello from frimmy.github.io">Contact</a></li>
          </ul> -->
        </div><!--/.nav-collapse -->
      </div>
    </div>
 ...
 <button><li><a href="http://127.0.0.1:8080/movies/index.php">Home</a></li></button>
  <button><li><a href="http://127.0.0.1:8080/movies/movie_search.php">Movie Search</a></li></button>
    ...
    <button><li><a href="http://127.0.0.1:8080/movies/movie_contact.php">contact</a></li></button>
        ...
        <footer>
          <p>Created by <a href="https://frimmy.github.io">Adrian Frimpong</a></p>
            <p>Edited by Tyler Miller</p>
        </footer>  
